...
import net.romeosnowblitz.hmh2.block.custom.*;
...
public class ModBlocks {
    ...
    public static final Block BANANA_SLAB = resisterBlock("banana_slab", new SlabBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block BANANA_STAIRS = resisterBlock("banana_stairs", new ModStairsBlock(ModBlocks.BANANA_LOG.getDefaultState(), FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block BANANA_DOOR = resisterBlock("banana_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block BANANA_TRAPDOOR = resisterBlock("banana_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block BANANA_BUTTON = resisterBlock("banana_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().noCollision()), ModItemGroup.ITEM);
    public static final Block BANANA_PRESSURE_PLATE = resisterBlock("banana_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block BANANA_FENCE = resisterBlock("banana_fence", new FenceBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block BANANA_FENCE_GATE = resisterBlock("banana_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    ...
    public static final Block CHERRY_SLAB = resisterBlock("cherry_slab", new SlabBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block CHERRY_STAIRS = resisterBlock("cherry_stairs", new ModStairsBlock(ModBlocks.CHERRY_LOG.getDefaultState(), FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block CHERRY_DOOR = resisterBlock("cherry_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block CHERRY_TRAPDOOR = resisterBlock("cherry_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block CHERRY_BUTTON = resisterBlock("cherry_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().noCollision()), ModItemGroup.ITEM);
    public static final Block CHERRY_PRESSURE_PLATE = resisterBlock("cherry_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block CHERRY_FENCE = resisterBlock("cherry_fence", new FenceBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block CHERRY_FENCE_GATE = resisterBlock("cherry_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    ...
    public static final Block JACARANDA_SLAB = resisterBlock("jacaranda_slab", new SlabBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block JACARANDA_STAIRS = resisterBlock("jacaranda_stairs", new ModStairsBlock(ModBlocks.JACARANDA_LOG.getDefaultState(), FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block JACARANDA_DOOR = resisterBlock("jacaranda_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block JACARANDA_TRAPDOOR = resisterBlock("jacaranda_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block JACARANDA_BUTTON = resisterBlock("jacaranda_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().noCollision()), ModItemGroup.ITEM);
    public static final Block JACARANDA_PRESSURE_PLATE = resisterBlock("jacaranda_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block JACARANDA_FENCE = resisterBlock("jacaranda_fence", new FenceBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block JACARANDA_FENCE_GATE = resisterBlock("jacaranda_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    ...
    public static final Block MANGO_SLAB = resisterBlock("mango_slab", new SlabBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block MANGO_STAIRS = resisterBlock("mango_stairs", new ModStairsBlock(ModBlocks.MANGO_LOG.getDefaultState(), FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block MANGO_DOOR = resisterBlock("mango_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block MANGO_TRAPDOOR = resisterBlock("mango_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block MANGO_BUTTON = resisterBlock("mango_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().noCollision()), ModItemGroup.ITEM);
    public static final Block MANGO_PRESSURE_PLATE = resisterBlock("mango_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block MANGO_FENCE = resisterBlock("mango_fence", new FenceBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block MANGO_FENCE_GATE = resisterBlock("mango_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    ...
    public static final Block MAHOE_SLAB = resisterBlock("mahoe_slab", new SlabBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block MAHOE_STAIRS = resisterBlock("mahoe_stairs", new ModStairsBlock(ModBlocks.MAHOE_LOG.getDefaultState(), FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block MAHOE_DOOR = resisterBlock("mahoe_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block MAHOE_TRAPDOOR = resisterBlock("mahoe_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block MAHOE_BUTTON = resisterBlock("mahoe_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().noCollision()), ModItemGroup.ITEM);
    public static final Block MAHOE_PRESSURE_PLATE = resisterBlock("mahoe_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block MAHOE_FENCE = resisterBlock("mahoe_fence", new FenceBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block MAHOE_FENCE_GATE = resisterBlock("mahoe_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    ...
    public static final Block WILLOW_SLAB = resisterBlock("willow_slab", new SlabBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block WILLOW_STAIRS = resisterBlock("willow_stairs", new ModStairsBlock(ModBlocks.WILLOW_LOG.getDefaultState(), FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block WILLOW_DOOR = resisterBlock("willow_door", new ModDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block WILLOW_TRAPDOOR = resisterBlock("willow_trapdoor", new ModTrapdoorBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().nonOpaque()), ModItemGroup.ITEM);
    public static final Block WILLOW_BUTTON = resisterBlock("willow_button", new ModStoneButtonBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool().noCollision()), ModItemGroup.ITEM);
    public static final Block WILLOW_PRESSURE_PLATE = resisterBlock("willow_pressure_plate", new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block WILLOW_FENCE = resisterBlock("willow_fence", new FenceBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);
    public static final Block WILLOW_FENCE_GATE = resisterBlock("willow_fence_gate", new FenceGateBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f).requiresTool()), ModItemGroup.ITEM);

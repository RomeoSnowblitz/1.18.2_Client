...
public class ModPowderSnowBlock extends Block {
    ...
    public ModPowderSnowBlock(Settings settings) {
        super(settings);
    }
        ...
        if (!(entity instanceof LivingEntity) || entity.getBlockStateAtPos().isOf(this)) {
            ...
            if (world.isClient) {
                ...
                if (bl && random.nextBoolean()) {
                    world.addParticle(ParticleTypes.EFFECT, entity.getX(), pos.getY() + 1, entity.getZ(), MathHelper.nextBetween(random, -1.0f, 1.0f) * 0.083333336f, 0.05f, MathHelper.nextBetween(random, -1.0f, 1.0f) * 0.083333336f);
                }
            }
        }

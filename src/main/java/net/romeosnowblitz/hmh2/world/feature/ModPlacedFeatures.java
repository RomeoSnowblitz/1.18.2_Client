...
public class ModPlacedFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> LIFE_ORE_PLACED = PlacedFeatures.register("life_ore_placed", ModConfiguredFeatures.LIFE_ORE, ModOreFeatures.modifiersWithCount(5, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(0), YOffset.aboveBottom(128))));
    ...
    public static final RegistryEntry<PlacedFeature> MARBLE = PlacedFeatures.register("marble", ModConfiguredFeatures.MARBLE, ModOreFeatures.modifiersWithCount(10, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(0), YOffset.aboveBottom(256))));
    public static final RegistryEntry<PlacedFeature> RAW_PLATINUM = PlacedFeatures.register("raw_platinum", ModConfiguredFeatures.RAW_PLATINUM, ModOreFeatures.modifiersWithCount(5, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(0), YOffset.aboveBottom(128))));

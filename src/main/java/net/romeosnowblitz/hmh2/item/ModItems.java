...
import net.romeosnowblitz.hmh2.item.custom.amulet.*;
...
public class ModItems {
    ...
    //MELEE WEAPONS
    public static final Item ANCHOR = registerItem("anchor", new SwordItem(ModToolMaterial.MOD_IRON, 14, -3.5f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item BATTLESTAFF = registerItem("battlestaff", new SwordItem(ModToolMaterial.STICK, 8, -2.45f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item BATTLESTAFF_OF_TERROR = registerItem("battlestaff_of_terror", new SwordItem(ModToolMaterial.ENDER_INGOT, 8, -2.6f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    ...
    public static final Item BREAD_KNIFE = registerItem("bread_knife", new SwordItem(ModToolMaterial.MOD_IRON, 4, 3.3f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item BROADSWORD = registerItem("broadsword", new SwordItem(ModToolMaterial.BONE, 11, -3.5f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item BROKEN_SAWBLADE = registerItem("broken_sawblade", new SwordItem(ModToolMaterial.BONE, 4, 0.25f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item CHILL_GALE_KNIFE = registerItem("chill_gale_knife", new SwordItem(ModToolMaterial.MYSTERIOUS_DEBRIS, 5, -1.85f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item CLAYMORE = registerItem("claymore", new SwordItem(ModToolMaterial.MOD_IRON, 11, -3.5f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item CORAL_BLADE = registerItem("coral_blade", new SwordItem(ModToolMaterial.CORAL, 2, -1.73f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item CUTLASS = registerItem("cutlass", new SwordItem(ModToolMaterial.MOD_IRON, 5, -2.2f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item ENCRUSTED_ANCHOR = registerItem("encrusted_anchor", new SwordItem(ModToolMaterial.MOD_GOLD, 14, -3.5f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item ETERNAL_KNIFE = registerItem("eternal_knife", new SwordItem(ModToolMaterial.ENDER_INGOT, 14, -3.5f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item FROST_FANG = registerItem("frost_fang", new SwordItem(ModToolMaterial.BLUE_ICE, 4, -0.35f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item FIREBRAND = registerItem("firebrand", new SwordItem(ModToolMaterial.HELLSTONE, 7, -2.95f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item GLAIVE = registerItem("glaive", new SwordItem(ModToolMaterial.MOD_IRON, 8, -3.2f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item GRAVE_BANE = registerItem("grave_bane", new SwordItem(ModToolMaterial.MOD_GOLD, 8, -3.2f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item GREAT_AXEBLADE = registerItem("great_axeblade", new SwordItem(ModToolMaterial.MOD_IRON, 11, -3.5f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item GROWING_STAFF = registerItem("growing_staff", new SwordItem(ModToolMaterial.STICK, 8, -2.6f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item HAWKBRAND = registerItem("hawkbrand", new SwordItem(ModToolMaterial.MOD_IRON, 6, -2.35f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item HEARTSTEALER = registerItem("heartstealer", new SwordItem(ModToolMaterial.MOD_IRON, 11, -3.5f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item HIGHLAND_AXE = registerItem("highland_axe", new SwordItem(ModToolMaterial.MOD_IRON, 7, -2.95f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item MECHANIZED_SAWBLADE = registerItem("mechanized_sawblade", new SwordItem(ModToolMaterial.MOD_IRON, 4, 0.25f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item MOON_DAGGER = registerItem("moon_dagger", new SwordItem(ModToolMaterial.MOD_IRON, 3, -0.35f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item NAMELESS_BLADE = registerItem("nameless_blade", new SwordItem(ModToolMaterial.ENDER_DUST, 5, -2.2f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    public static final Item NIGHTMARES_BITE = registerItem("nightmares_bite", new SwordItem(ModToolMaterial.POISON_SAC, 4, -1.35f, new FabricItemSettings().group(ModItemGroup.ITEM)));
    ...
    //Amulets
    public static final Item AMULET_OF_ACCELERATION = registerItem("amulet_of_acceleration", new SpeedAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_ANTIGRAVITY = registerItem("amulet_of_antigravity", new LevitationAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_ARTHRITIS = registerItem("amulet_of_arthritis", new MiningFatigueAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    ...
    public static final Item AMULET_OF_BRICKS = registerItem("amulet_of_bricks", new InstantDamageAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_BRO_YOU_GOTTA_TRY_THIS = registerItem("amulet_of_bro_you_gotta_try_this", new NauseaAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_BUBBLES = registerItem("amulet_of_bubbles", new WaterBreathingAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_CLOAKING = registerItem("amulet_of_cloaking", new InvisibilityAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_CLOSED_EYES = registerItem("amulet_of_closed_eyes", new BlindnessAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    ...
    public static final Item AMULET_OF_DECAY = registerItem("amulet_of_decay", new WitherAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_ENDURANCE = registerItem("amulet_of_endurance", new AbsorptionAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_EXCAVATION = registerItem("amulet_of_excavation", new HasteAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_EXTRA_LOVE = registerItem("amulet_of_extra_love", new HealthBoostAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_FLAMELESSNESS = registerItem("amulet_of_flamelessness", new FireResistanceAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_FRAILTY = registerItem("amulet_of_frailty", new WeaknessAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_GILLS = registerItem("amulet_of_gills", new ConduitPowerAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    ...
    public static final Item AMULET_OF_HEALING = registerItem("amulet_of_healing", new RegenerationAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_HERCULES = registerItem("amulet_of_hercules", new StrengthAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_ILLUMINATION = registerItem("amulet_of_illumination", new GlowingAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_LEAPING = registerItem("amulet_of_leaping", new JumpBoostAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_NIGHT_SIGHT = registerItem("amulet_of_night_sight", new NightVisionAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_NOURISHMENT = registerItem("amulet_of_nourishment", new SaturationAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_OLYMPIC_SWIMMING = registerItem("amulet_of_olympic_swimming", new DolphinsGraceAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_RAIDS = registerItem("amulet_of_raids", new BadOmenAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_REJUVINATION = registerItem("amulet_of_rejuvination", new InstantHealthAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_SHIELDING = registerItem("amulet_of_shielding", new ResistanceAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_SICKENING = registerItem("amulet_of_sickening", new PoisonAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    public static final Item AMULET_OF_THE_PHANTOM = registerItem("amulet_of_the_phantom", new SlowFallingAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
    ...
    public static final Item AMULET_OF_THE_VILLAGE_HERO = registerItem("amulet_of_the_village_hero", new HeroOfTheVilliageAmuletItem(new FabricItemSettings().maxDamage(64).group(ModItemGroup.ITEM)));
